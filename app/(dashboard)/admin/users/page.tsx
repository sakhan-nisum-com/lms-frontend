...
const statusColors: Record<PlatformUserStatus, React.CSSProperties> = {
  ...
  inactive: { backgroundColor: "var(--bg-surface-muted)", color: "var(--text-secondary)" },
  suspended: { backgroundColor: "var(--danger-bg)", color: "var(--danger)" },
            ...
            <tbody>
              {filtered.map((u, i) => (
                ...
                >
                  <td className="px-5 py-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="min-w-0">
                        <Link href={`/admin/users/${u.id}`} className="font-medium truncate hover:underline block" style={{ color: "var(--text-primary)" }}>
                          {u.name}
                        </Link>
                  ...
                  <td className="px-5 py-4" style={{ color: "var(--text-secondary)" }}>{u.department}</td>
                  <td className="px-5 py-4">
                    <select
                      value={u.status}
                  ...
                  <td className="px-5 py-4" style={{ color: "var(--text-secondary)" }}>{u.lastActive}</td>
                  <td className="px-5 py-4">
