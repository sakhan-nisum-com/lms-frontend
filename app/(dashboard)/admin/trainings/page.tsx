    ...
    <DashboardLayout role="admin" userName="Morgan Patel">
      <div className="space-y-6 max-w-6xl">
        ...
        <div className="space-y-3">
          {filtered.map((t) => (
            <div key={t.id} className="rounded-2xl p-5" style={{ backgroundColor: "#1E293B", border: "1px solid #334155" }}>
                ...
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    <div className="flex items-center gap-2 flex-wrap">
                      <Link href={`/admin/trainings/${t.id}`} className="text-sm font-bold text-white hover:underline">
                        {t.title}
                      </Link>
                      <span className="text-xs px-1.5 py-0.5 rounded-full font-semibold capitalize" style={{ backgroundColor: "#33415560", color: "#94A3B8" }}>
                        {t.type}
                      </span>
                ...
                <div className="flex items-center gap-3 flex-shrink-0">
                  <button
                    ...
                    style={{
                      ...
                      color: t.isMandatory ? "#F87171" : "#94A3B8",
                    }}
                  >
              ...
              <div className="mt-4">
                <div className="flex items-center justify-between text-xs mb-1">
                  <span style={{ color: "#64748B" }}>Average completion across enrolled users</span>
                  <span className="font-semibold text-white">{t.progress}%</span>
                </div>
          ...
          {filtered.length === 0 && (
            <div className="rounded-2xl p-10 text-center" style={{ backgroundColor: "#1E293B", border: "1px dashed #334155" }}>
              <p className="text-sm" style={{ color: "#475569" }}>No training tracks match these filters.</p>
            </div>
          )}
        </div>
      </div>
