      ...
      <div className="space-y-6">
        ...
        {registered.length === 0 ? (
          <div className="rounded-2xl p-12 text-center" style={{ backgroundColor: "#1E293B", border: "1px dashed #334155" }}>
            <Wrench size={36} className="mx-auto mb-3" style={{ color: "#334155" }} />
            <p className="text-sm font-medium text-white mb-1">No workshops registered yet</p>
            <p className="text-xs mb-4" style={{ color: "#64748B" }}>Browse upcoming hands-on sessions and save your seat.</p>
            <Link
              href="/student/workshops"
